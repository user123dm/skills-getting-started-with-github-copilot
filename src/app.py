...
activities = {
    ...
    "Basketball": {
        "description": "Team sport focused on shooting, dribbling, and court strategy",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu"]
    },
    "Tennis": {
        "description": "Racquet sport with singles and doubles matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["jessica@mergington.edu", "ryan@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore various artistic techniques including painting and sculpture",
